...
$pil = "SELECT * FROM user_for WHERE user_type = 'user' ";
$stud = $conn->query($pil) or die ($conne->error);
  ...
  <section id="hero">
    <div class="hero-container">
        <div data-aos="fade-in">
            ...
            <h1>Welcome to Ar-Tour</h1>
            <h2>Welcome <span class="typed" data-typed-items="<?php echo $result['user_type']; ?>"></span></h2>
            <div class="actions">
                <a href="User_side/user_index.php" class="btn-get-started">Get Strated</a><br>
                <a href="Tiaong_nolog.php" class="btn-get-started">Log Out</a>
            </div>
        </div>
    </div>
  </section><!-- End Hero -->
