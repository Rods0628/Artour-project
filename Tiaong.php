...
$pil = "SELECT * FROM user_for WHERE user_type = 'admin' ";
  ...
  <section id="hero">
    <div class="hero-container">
        <div data-aos="fade-in">
            ...
            <div class="actions">
                <a href="Admin_side/admin_index.php" class="btn-get-started">Get Strated</a><br>
                <a href="index.php" class="btn-get-started">Log Out</a>
            </div>
        </div>
    </div>
  </section><!-- End Hero -->
